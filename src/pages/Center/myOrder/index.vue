<template>
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        <!-- 每个table为每个订单交易 -->
        <table class="order-item" v-for="item in myOrder.records" :key="item.id">
          <thead>
            <tr>
              <th colspan="5">
            ...
            <tr v-for="(cart,index) in item.orderDetailList" :key="cart.id">
              <td width="60%">
                <div class="typographic">
                  <img :src="cart.imgUrl" style="height: 100px;weight: 100px" />
      ...
      <div class="choose-order">
        <APagination :pageNo="page" :pageSize="limit" :total="myOrder.total" :continues="5" @getPageNo="getPageNo" ref="Apagination"/>
      </div>
    </div>
    <!--猜你喜欢-->
    <div class="like">
...
export default {
  ...
  mounted(){
    this.getData()
    this.refs.Apagination.$on('getPageNo',this.getPageNo)
  },
  methods:{
   async getData(){ 
